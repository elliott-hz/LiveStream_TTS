...
async def test_binding_create_and_list(db_session):
    ...
    from services.platform_svc.src.modules.platform_sync.services.binding_service import BindingService
...
async def test_sync_product_push(db_session):
    ...
    from services.platform_svc.src.modules.platform_sync.services.sync_service import SyncService
