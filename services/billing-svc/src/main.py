...
from api.grpc_impl import BillingServiceServicer
...
async def serve() -> None:
    setup_logging(service_name="billing-svc", json_format=config.env != "dev")
    ...
    def _make_svc():
        ...
        return BillingService(db=db.session())
    ...
    servicer = BillingServiceServicer(service_factory=_make_svc)
    pb_grpc.add_BillingServiceServicer_to_server(servicer, grpc_server)
